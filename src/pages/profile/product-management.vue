<template>
	<view class="page-container" :class="{'dark-mode': isDarkMode}">
		...
		<view class="products-list">
			...
			<view v-else class="product-item" v-for="(item, index) in products" :key="index" :class="{'dark-mode': isDarkMode}">
				<view class="product-info">
					...
					<view class="product-details">
						...
						<view class="product-meta">
							...
							<text class="product-stock" :class="{'stock-unlimited': item.stock === '无限', 'stock-empty': item.stock === 0 || item.stock === '0'}">
		...
		<view class="stock-popup" v-if="showStockPopup">
			...
			<view class="stock-popup-content" :class="{'dark-mode': isDarkMode}">
				...
				<input 
					...
					placeholder="请输入库存数量，输入'无限'表示无限库存"
					focus="true"
				/>
