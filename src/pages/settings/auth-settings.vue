		...
		<view class="auth-settings">
			...
			<view class="modal-mask" v-if="showPasswordModal" @tap="closePasswordModal">
				<view class="modal-content" @tap.stop>
					...
					<block v-if="authSettings.hasPassword">
						<view class="password-input-box">
							<input :type="oldPasswordVisible ? 'text' : 'password'" v-model="oldPassword"
								placeholder="请输入原密码" class="password-input" />
							<text class="password-toggle-icon" @tap="oldPasswordVisible = !oldPasswordVisible">
					...
					<!-- 新密码输入框 -->
					<view class="password-input-box">
						<input :type="newPasswordVisible ? 'text' : 'password'" v-model="newPassword"
							placeholder="请输入新密码(6-40个字符)" class="password-input" />
						<text class="password-toggle-icon" @tap="newPasswordVisible = !newPasswordVisible">
					...
					<view class="password-input-box">
						<input :type="confirmPasswordVisible ? 'text' : 'password'" v-model="confirmPassword"
							placeholder="请确认新密码" class="password-input" />
						<text class="password-toggle-icon" @tap="confirmPasswordVisible = !confirmPasswordVisible">
