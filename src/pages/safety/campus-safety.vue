...
const category = ref(SAFETY_CATEGORIES.CAMPUS)
...
const categoryName = computed(() => CATEGORY_INFO[category.value]?.name || '校园安全')
const categoryIcon = computed(() => CATEGORY_INFO[category.value]?.icon || '🏫')
const categoryColor = computed(() => CATEGORY_INFO[category.value]?.color || '#27AE60')
