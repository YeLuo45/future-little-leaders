                ...
                <view class="task-progress">
                  ...
                  <view class="progress-bar">
                    <view 
                      ...
                      :style="{ width: calculateProgress(task.completed || 0, task.total || 0) + '%' }"
                    ></view>
                  </view>
                </view>
              </view>
      ...
      <view class="task-section">
        ...
        <view v-show="!isRecurringCollapsed">
          ...
          <template v-if="recurringTasks && recurringTasks.length > 0">
            <view 
              class="task-card"
              v-for="(task, index) in recurringTasks" 
...
.page-container {
  ...
  position: relative;
  z-index: 0; /* 确保页面容器的z-index低于其他元素 */
...
.content-list {
  ...
  overflow: hidden;
  position: relative;
  z-index: 1; /* 确保scroll-view在悬浮按钮下方 */
}
