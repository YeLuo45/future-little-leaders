  ...
  <view class="page-container">
    ...
    <view class="form-container">
      ...
      <view class="form-item">
        ...
        <input class="form-input" v-model="productForm.points" type="number" placeholder="请输入所需积分"
      ...
      <view class="form-item">
        ...
        <input class="form-input" v-model="productForm.stock" placeholder="请输入库存数量，无限则填'无限'"
          placeholder-class="placeholder" />
      </view>
      ...
      <view class="form-item">
        ...
        <textarea class="form-textarea" v-model="productForm.description" placeholder="请输入商品描述（可选）"
